...
若存在 ap1 = ap2 = ... = apm = x 且 m > n/2 (0 ≤ pk < n, 1 ≤ k ≤ m)，则称 x 为 A 的主元素。例如 A = (0, 5, 5, 3, 5, 7, 5, 5)，则 5 为主元素；
...
- 算法思想：
  [Boyer-Moore 投票算法](https://blog.csdn.net/qq_40206371/article/details/118599874)
    - 遍历数组，如果当前元素与候选元素相同，则计数器加1，否则减1
    - 如果计数器为0，则将当前元素设置为候选元素
    - 计数器大于0则返回候选元素
- 实现 [2013_寻找数组主元素](answer_13.cpp)
