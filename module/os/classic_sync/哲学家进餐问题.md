...
<img
src="https://cdn.nlark.com/yuque/0/2025/png/38757749/1756693155896-39e885e0-fca8-4953-b5f2-6a83dceba895.png?x-oss-process=image%2Fformat%2Cwebp"
alt="哲学家进餐问题" style="width: 50%; max-width: 600px; height: auto;" />
...
**破坏<font color = "red">请求并保持条件</font>**

```cpp
semaphore chopstick[5] = {1, 1, 1, 1, 1};           // 互斥信号量，确保对筷子操作的互斥，初始值为1
semaphore mutex = 1;                                // 互斥信号量，确保对筷子操作的互斥，初始值为1
